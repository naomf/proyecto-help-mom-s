                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('semanas') ? ' has-error' : '' }}">
                            <label for="semanas" class="col-md-4 control-label">semanas</label>

                            <div class="col-md-6">
                                <input id="semanas" type="date" class="form-control" name="semanas" value="{{ old('semanas') }}" required autofocus>
